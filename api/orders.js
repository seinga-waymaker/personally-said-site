...
async function listOrders(req, res) {
  ...
  // Paid sessions with no card = webhook gap. Check Redis directly since the
  // card may be older than the page of cards above.
  const unfulfilled = [];
...
async function createManualCard(req, res) {
  ...
  let twilioCode;
  if (body.code) {
    // Explicit code (e.g. legacy "0831"): keep it exactly.
